...
<body>
    <main class="max-w-2xl m-auto px-4 relative">
        ...
        <!-- Article -->
        <div
            class="rounded-xl w-full max-w-2xl m-auto px-4 py-5 my-5 bg-woodsmoke-800 text-white shadow-maroon-flush-300 shadow-md">
        ...
        <div>
            ...
            <div>
                <form method="POST" class="flex space-x-2">
                    ...
                    <button type="submit"
                        class="bg-blue-600 text-white rounded-lg px-3 py-1 hover:bg-blue-700">Send</button>
                </form>
            </div>
