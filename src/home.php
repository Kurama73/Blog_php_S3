...
<body>
    ...
    <main class="max-w-2xl m-auto px-4">
        ...
        <div class="home-header flex justify-between my-9">
            ...
            <form method="get" action="home.php" class="flex w-7/12">
                ...
                <input type="submit" name="bt-filter" value="Filter"
                    class="home-header-filter hidden sm:flex w-1/5 px-3.5 cursor-pointer hover:bg-maroon-flush-700">
                <input type="image" src="./images/icons/gi_filter.svg" alt="filter-con"
                    class="home-header-filter flex sm:hidden px-2">
            ...
            <form method="post" action="add-article.php">
                ...
                <input type="submit" name="bt-create-article" value="Create an article"
                    class="hidden sm:flex rounded-2xl px-3.5 mx-3 cursor-pointer hover:bg-maroon-flush-700">
                <input type="image" src="./images/icons/gi_post.svg" alt="create-article-icon"
                    class="flex sm:hidden rounded-2xl px-2">
        ...
        <!-- Article -->
        <div
            class="flex flex-col w-full m-auto shadow-[0px_4px_10px_rgba(0,0,0,0.2),0px_8px_20px_rgba(0,0,0,0.15),0px_12px_30px_rgba(255,124,163,0.7),0px_20px_50px_rgba(255,124,163,0.6)]">
                ...
                <a href="article.php?id=<?php echo $row['id_article']; ?>&filter=<?php echo urlencode($filter); ?>">
                    ...
                    <div class="article w-full bg-woodsmoke-800 p-4 border-b-2 border-maroon-flush-300 text-white" <?php echo $border_radius; ?>>
                        ...
                        <div class="px-4 py-5">
                            ...
                            <h1 class="article-title font-bold mb-1 break-words">
                                <?php echo htmlspecialchars($row['titre']); ?></h1>
                            <p class="mb-4 break-words overflow-hidden overflow-ellipsis">
